...
# Unitree G1 (sim) with Dex1 grippers: 7-DoF arms + 1-DoF gripper per side.
# State/action layout matches meta/modality.json: left_arm(7) + right_arm(7)
# + left_gripper(1) + right_gripper(1) = 16 dims.
g1_dex1_config = {
    ...
    "action": ModalityConfig(
        ...
        action_configs=[
            ...
            # grippers: ABSOLUTE = target position (binary open/close works better absolute)
            ActionConfig(

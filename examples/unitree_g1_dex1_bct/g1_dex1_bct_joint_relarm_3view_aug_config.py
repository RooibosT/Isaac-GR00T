...
"""BCT config: RELATIVE arms, 3 views, augmented 46-dim state, stall-free data.
...
g1_dex1_bct_joint_relarm_3view_aug_config = {
...
register_modality_config(
    g1_dex1_bct_joint_relarm_3view_aug_config, embodiment_tag=EmbodimentTag.NEW_EMBODIMENT
)
